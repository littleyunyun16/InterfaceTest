...
def add_tradeorder():
    ...
    no_repeat_sumit_tradeOrderHeaderAddOrUpdate=re.findall('<input type="hidden" name="no_repeat_sumit_tradeOrderHeaderAddOrUpdate" value="(.+?)"/>',res)[0]
    # print(token)
    # print(uniqueTid)
